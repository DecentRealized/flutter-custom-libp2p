...
class CustomLibP2PPlugin {
  var _counter = 0;
  Worker worker = new Worker('assets/packages/custom_libp2p/web/assets/worker.js');
  ...
  static void registerWith(Registrar registrar) {
    final MethodChannel channel = MethodChannel(
        ...
        registrar.messenger);
    final CustomLibP2PPlugin instance = CustomLibP2PPlugin();
    instance.listen();
